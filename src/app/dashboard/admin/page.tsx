...
export default function AdminDashboardPage() {
    return (
        <div className="flex flex-col">
            ...
            <div className="mb-8">
                <div className="flex justify-between items-start">
                    <div>
                        ...
                        <p className="text-gray-500">Here's what's happening with your system today.</p>
                    </div>
                    <div className="text-right text-xs text-gray-400">
                        <p>Admin ID</p>
                        <p className="font-mono bg-gray-100 px-2 py-1 rounded">admin-master-key-001</p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-center text-sm">
                                ...
                                <span className="bg-green-100 text-green-700 px-2 py-0.5 rounded text-xs font-semibold">MAP 8A</span>
                            </div>
                            <div className="flex justify-between items-center text-sm">
            ...
            {/* Bottom Row: Top Users, Transactions, Traffic */}
            ...
            {/* Footer Message */}
            <div className="mt-12 text-center text-xs text-gray-400 font-medium pb-8">
